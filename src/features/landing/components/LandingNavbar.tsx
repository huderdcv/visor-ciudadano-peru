...
export const LandingNavbar = () => {
  ...
  return (
    <header className="bg-slate-50 dark:bg-slate-950 flex justify-between items-center h-20 shadow-md px-8 fixed z-40 top-0 w-full dark:border-b dark:border-slate-800">
      <Link href={'/'} className="flex gap-2 items-center group">
        ...
        <span className="text-slate-900 dark:text-white font-bold text-xl hidden lg:block">
          Visor Ciudadano
        </span>
      </Link>
